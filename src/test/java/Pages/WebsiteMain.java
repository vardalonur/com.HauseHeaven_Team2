...
////////////////////////==================\\\\\\\\\\\\\\\\\\\\\\\\
    ...
    */
    ...
    public WebElement minPriceArrow;

    @FindBy(xpath = "//*[@data-select2-id='select2-data-15-2u8e']")
    public WebElement minPrice_1000;

    @FindBy(xpath = "(//*[@class='select2-selection__clear'])[1]")
    public WebElement minPriceClearButton;

    @FindBy(xpath = "//*[@id='select2-maxprice-container']")
    public WebElement maxPriceBar;

    @FindBy(xpath = "(//*[@class='select2-selection__arrow'])[2]")
    public WebElement maxPriceArrow;

    @FindBy(xpath = "(//*[@class='select2-selection__clear'])[2]")
    public WebElement maxPriceClearButton;
    ...
    @FindBy(xpath = "//*[@data-select2-id='select2-data-65-lglk']")
    public WebElement villaOption;

    @FindBy(xpath = "(//*[@class='select2-selection__clear'])[3]")
    public WebElement propertyTypeClearButton;
    ...
    public WebElement bedroomsArrow;
    ...
    public WebElement propertyLocationArrow;

    @FindBy(xpath = "//*[@title='Amarillo, ']")
    public WebElement amarilloOption;
